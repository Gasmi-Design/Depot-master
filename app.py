...
with st.container():
 ...
 st.markdown("<h1>جامعة محمد البشير الإبراهيمي - برج بوعريريج<br>كلية علوم الطبيعة والحياة وعلوم الأرض والكون</h1>", unsafe_allow_html=True)
    st.markdown("<h3>📚 منصة إيداع مذكرات التخرج</h3>", unsafe_allow_html=True)
